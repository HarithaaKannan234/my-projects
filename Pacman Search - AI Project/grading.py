...
class Grades:
    ...
    def __init__(
        ...
        print(f"Starting on {TIMEZONE}: {now}\n")
...
"""
            ...
            try:
                ...
                timed_func = timeout.TimeoutFunction(
                    question_function, question_timeout
                )
        ...
        print(
            "Total: %d/%d"
            % (self.points.totalCount(), sum([n for n in self.maxes.values() if n > 0]))
        )
